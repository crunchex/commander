...
class CmdrCamera {
  ...
  CmdrCamera(this.cameraNum) {
    ...
    int portIListenOn = 13060 + cameraNum; //0 is random
...
//      print('Did send data on the stream..');
  ...
  void _runFFMpeg() {
    ...
    List<String> options = ['-s', '640x480', '-f', 'video4linux2', '-input_format', 'mjpeg', '-i', '/dev/video${cameraNum - 1}', '-f', 'mpeg1video', '-b', '800k', '-r', '20', 'udp://127.0.0.1:1306${cameraNum}'];
